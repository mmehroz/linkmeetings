		...
		<div class="container">
			<div class="row va-end">
				...
				<div class="col-sm-7 col-md-9 col-6 text-right">
					...
					<ul class="navigation">
					@foreach( $menu_description as $data )
					<li><a href="{{ route('page_view',['name'=>$data->slug]) }}">{{ $data->title }}</a></li>
					@endforeach
					@if( isUserLoggedIn())
					...
					<div class="logged-in-info">
						<figure>
							{{ HTML::image('images/user-ava-logged.png', 'Link Meetings') }}
						</figure>
						<span> <small>Veeti Seppanen</small>
