			...
			<div class="col-12">
				<div class="panel">
					<div class="panel-tab-info">
						<h2>@lang('admin/faqcategory.faqcategorylist')</h2>
...
{{--						</div>--}}
					...
					<table class="display info-data data-tble-pages dataTable no-footer" id="categoryfaqs-list">
					    <thead>
					        <tr>
...
<script>
    $(function() {
        var table = $('#categoryfaqs-list').DataTable({
            processing: true,
            //serverSide: true,
            ajax: '{!! route('admin_faqscategory_data') !!}',
            columns: [
                { data: 'faq_category_id', name: 'faq_category_id' },
