			...
			<div class="col-12">
				<div class="panel">
					<div class="panel-tab-info">
						<h2>@lang('admin/subscriber.list')</h2>
					...
					<table class="display info-data" id="subscriber-list">
					    <thead>
					        <tr>
								<th>@lang('admin/subscriber.id')</th>
								<th>@lang('admin/subscriber.emails')</th>
{{--                                <th>@lang('admin/subscriber.status')</th>--}}
								<th>@lang('admin/subscriber.created_at')</th>
					        </tr>
					    </thead>
...
<script>
    $(function() {
        var table = $('#subscriber-list').DataTable({
            processing: true,
            // serverSide: true,
            ajax: '{!! route('admin_subscribers_data') !!}',
            columns: [
                { data: 'id', name: 'id' },
