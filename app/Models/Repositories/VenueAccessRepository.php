...
use App\Models\VenueAccess as MainModel;
use App\Models\VenueAccessDescription as DescriptionModel;
use App\Models\Languages;

class VenueAccessRepository  extends AbstractRepository
{
    public $model;
    protected $table                                        = 'venue_access';
    protected $description_table                            = 'venue_access_description';
    protected $foriegn_key                                  = 'venue_access_id';
