...
<html>
				...
				<div class="col-sm-6">
					<div class="head-right">
						<ul>
							...
							<li>
								<div class="pkg-info">
									<h3>Your Package: <strong class="green">{{ $dmc_user_dashboard_details->title ?? '' }}</strong></h3>
								</div>
							</li>
							<li>
								<div class="user-info">
	...
	<aside class="lft-nav">
		...
		<ul class="shrink-nav">
			<li>
				<i class="icon icon-dash"></i> <a href="{{ URL::to('dmc/dashboard') }}">Dashboard</a>
			</li>
			<li class="drp">
				<i class="icon icon-booking"></i> <a href="javascript:;">Bookings</a> <i class="fa fa-angle-down rht"></i>

				<ul class="submenu">
					<li><a href="{{ URL::to('/dmc/booking-inquries') }}">Inquiries</a> <span class="count">2</span></li>
					<li><a href="{{ URL::to('/dmc/booking-proposal-sent') }}">Proposal Sent</a></li>
					<li><a href="{{ URL::to('/dmc/booking-pending') }}">Pending</a></li>
					<li><a href="{{ URL::to('/dmc/booking-confirmed') }}">Confirmed</a></li>
					<li><a href="{{ URL::to('/dmc/booking-canceled') }}">Canceled</a></li>
				</ul>
			</li>
			<li>
				<i class="icon icon-dmc"></i> <a href="{{ route('dmc_dmc') }}">DMC</a>
			</li>
			<li>
