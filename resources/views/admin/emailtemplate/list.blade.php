			...
			<div class="col-12">
				<div class="panel">
					<div class="panel-tab-info">
						<h2>@lang('admin/emailtemplate.emaillist')</h2>
                            <div class="tab-info">
{{--							<ul>--}}
{{--								<li>--}}
...
{{--						</div>--}}
					...
					<table class="display info-data data-tble-pages dataTable no-footer" id="email-list">
					    <thead>
					        <tr>
...
<script>
    $(function() {
        var table = $('#email-list').DataTable({
            processing: true,
            //serverSide: true,
            ajax: '{!! route('admin_email_data') !!}',
            columns: [
                { data: 'id', name: 'id' },
                { data: 'slug', name: 'slug' },
