                ...
                <div class="panel"> <!-- panel -->
                    <div class="row"> <!-- row -->
                        <div class="col-md-12 col-sm-12 col-xl-11">	<!-- col-md-12 col-sm-12 col-xl-11 -->
                            ...
                            <div class="row">
                                <div class="col-xl-8">
                                    <h2>@lang('admin/package.add')</h2>
                                </div>
                            </div>

                            {!! Form::open(array('route' => 'admin_package_add_post', 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="field">
                                                        ...
                                                        <input type="text" value="{{ old('title-'.$language->id) }}" name="title-{{ $language->id }}" placeholder="@lang('admin/package.title')">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="field">
                                                        ...
                                                        <input type="text" value="{{ old('short_title-'.$language->id) }}" name="short_title-{{ $language->id }}" placeholder="@lang('admin/package.shorttitle')" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="field">
                                                        ...
                                                        <textarea name="details-{{ $language->id }}" value="{{ old('details-'.$language->id) }}" class="form-control my-editor">{{ old('details-'.$language->id) }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="field">
                                                    ...
                                                    <input type="number" value="{{ old('price') }}" name="price" placeholder="@lang('admin/package.price')" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="field">
                                                    ...
                                                    <input type="number" value="{{ old('week_deal_posting') }}" name="week_deal_posting" placeholder="@lang('admin/package.week_deal_posting')" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="field">
                                                    ...
                                                    <input type="number" value="{{ old('email_blast') }}" name="email_blast" placeholder="@lang('admin/package.email_blast')" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="field">
                                                    ...
                                                    <input type="number" value="{{ old('promo_article') }}" name="promo_article" placeholder="@lang('admin/package.promo_article')" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="field">
                                                    ...
                                                    <input type="number" value="{{ old('landing_page_posting') }}" name="landing_page_posting" placeholder="@lang('admin/package.landing_page_posting')" />
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="field">
                                                    <select name="type" class="">
                                                        ...
                                                        <option value="DMC" @if( old('type') == 'DMC' ) selected="" @endif>DMC</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="field">
                                                    <select name="status" class="">
                                                        ...
                                                        <option value="Active" @if( old('status') == 'Active' ) selected="" @endif>@lang('admin/package.status_options.active')</option>
                                                        <option value="Inactive" @if( old('status') == 'Inactive' ) selected="" @endif>@lang('admin/package.status_options.inactive')</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-5">
                                    <a href="{{ route('admin_packages') }}" class="primary-btn dblue extended">@lang('admin/package.cancel')</a>
                                </div>
                                <div class="col-sm-5">
