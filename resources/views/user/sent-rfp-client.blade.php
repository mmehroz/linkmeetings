...
@stop
@section('body-class') rfp-preview-pg client @stop
@section('content')
...
<div class="content-area">
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12 col-sm-12 col-lg-12 col-xl-11 ctrdv">
				<div class="panel">
					<div class="row">
								...
								<div class="col-sm-12">
									<div class="info-tp mbpx-30">
										...
										<div class="row mbpx-12">
											...
											<div class="col-md-6 col-lg-4">
												<h5 class="mbpx-50 or">
													<strong>Booking Status</strong> Proposal Sent on April 30, 2020 (06:15 PM)
												</h5>

												<h5>
													<strong>Manager:</strong> Mark Manson
												</h5>
											</div>
										</div>
									</div>
