...
<section class="cookie-sec wow fadeInUp" data-wow-delay="0.2s">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<h1 class="main">Cookies Policy</h1>
				<p><small>Last updated: June 26, 2020</small></p>
				...
				<li><strong>Website</strong> refers to Link Meetings, accessible from <a href="www.linkmeetings.global" rel="external nofollow noopener" target="_blank">www.linkmeetings.global</a>.</li>
				</ul>
