                                                        ...
                                                        <select class="add-hotel-slct-disable" name="user">
                                                            ...
                                                            @if($hotel_users->count())
                                                                @foreach($hotel_users as $user)
                                                                    <option value="{{ $user->id }}" @if( old('user') == $user->id ) selected="" @endif >{{ $user->first_name }} {{ $user->last_name }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="field mbpx-15">
                                                        <select class="add-hotel-slct-disable" name="is_featured">
                                                            <option value="0" @if( old('is_featured') == 0 ) selected @endif>@lang('hotel/add.is_featured_options.no')</option>
                                                            <option value="1" @if( old('is_featured') == 1 ) selected @endif>@lang('hotel/add.is_featured_options.yes')</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
