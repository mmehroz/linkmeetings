					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xl-11">	
                            ...
                            <div class="col-sm-12">
                                    ...
                                    {!! Form::open(array('route' => array('admin_faq_update_post',$id), 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
                                                            ...
                                                            <div class="col-sm-6">
                                                                ...
                                                                <label>@lang('admin/faq.faqcategory')</label>
                                                                    <select name="parent_id-{{ $language->id }}">
                                                                        <option value="">No Faq</option>
                                                                        <?php $parent_cats = $getfaq->getFaqCategories($language->id);?>
                                                                        @if($parent_cats)
                                                                            @foreach($parent_cats as $parent_cat)
                                                                            <option value="{{ $parent_cat->faq_category_id }}" @if( $faqcatparent->faq_category_id == $parent_cat->faq_category_id ) selected @endif>{{ $parent_cat->title }}</option>
                                                                            @endforeach
                                                                        @endif
																	</select>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="field">
                                                                    ...
                                                                    <input type="text" value="{{ old('title-'.$language->id,$gettittile) }}" name="title-{{ $language->id }}" placeholder="Faq title..." />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="field">
                                                                    ...
                                                                    <!-- <input type="text" value="{{ old('description-'.$language->id,$getdescription) }}" name="description-{{ $language->id }}" placeholder="Faq description..." /> -->
                                                                    <textarea name="description-{{ $language->id }}" class="form-control my-editor" >{{ old('description-'.$language->id,$getdescription) }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
