...
use App\Models\RoomFacility as MainModel;
use App\Models\RoomFacilityDescription as DescriptionModel;
use App\Models\Languages;

class RoomFacillityRepository  extends AbstractRepository
{
    public $model;
    protected $table                                        = 'guest_room_facilities';
    protected $description_table                            = 'guest_room_facilities_description';
    protected $foriegn_key                                  = 'room_facility_id';
