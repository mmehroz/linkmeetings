					...
					<div class="row">
						<div class="col-sm-12 col-md-10 col-lg-7">
							...
							<div class="row va-ctr">
								<div class="col-sm-7">
									<a href="{{ URL::to('/create-banner-ad') }}" class="link-back"><i class="fa fa-angle-left"></i> Back</a>	
								</div>
								<div class="col-sm-5">
									<a href="{{ URL::to('/create-banner-ad-pay') }}" class="primary-btn dblue">Make Payment</a>			
								</div>
							</div>
						</div>
					</div>
