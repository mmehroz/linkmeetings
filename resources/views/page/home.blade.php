	...
	<div class="main-txt">
		<div class="container">
			<div class="cont">
				<div class="row">
					<div class="col-sm-12">
						<h2 class="wow slideInLeft" data-wow-delay="0.4s">Find incredible Destinations, Request proposals, book events</h2>
					</div>
				</div>
...
<section class="meeting-sec wow fadeInUp" data-wow-delay="0.2s">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<h2>Book Inspiring Meeting Spaces</h2>
			</div>
		</div>
		<div class="row">
...
<section class="building-sec wow fadeInUp" data-wow-delay="0.2s">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<h2>Book Inspiring Experiences</h2>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12 col-md-4 wow fadeIn" data-wow-delay="0.6s">
