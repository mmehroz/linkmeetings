...
use App\Models\Equipment as MainModel;
use App\Models\EquipmentDescription as DescriptionModel;
...
class EquipmentRepository  extends AbstractRepository
{
    ...
    protected $description_table                            = 'equipments_description';
    protected $foriegn_key                                  = 'equipment_id';
