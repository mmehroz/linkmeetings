...
{{--						</div>--}}
					...
					<table class="display info-data data-tble-pages dataTable no-footer" id="faqs-list">
					    <thead>
					        <tr>
...
<script>
    $(function() {
        var table = $('#faqs-list').DataTable({
            processing: true,
            //serverSide: true,
            ajax: '{!! route('admin_faq_data') !!}',
            columns: [
                { data: 'id', name: 'id' },
