                ...
                <div class="panel"> <!-- panel -->
                    <div class="row"> <!-- row -->
                        <div class="col-md-12 col-sm-12 col-xl-11">	<!-- col-md-12 col-sm-12 col-xl-11 -->
                            ...
                            {!! Form::open(array('route' => array('admin_blog_update_post',$id), 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}

                                @foreach($languages as $language)
                                <?php
                                    $blogDescription = $getblog->getDescriptionById($id,$language->id);
                                ?>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="field">
                                                        ...
                                                        <input type="text" value="{{ old('title-'.$language->id,$blogDescription->title ??'') }}" name="title-{{ $language->id }}" placeholder="Blog title here..." />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="field">
                                                        ...
                                                        <input type="text" value="{{ old('short_title-'.$language->id,$blogDescription->short_title ?? '') }}" name="short_title-{{ $language->id }}" placeholder="Page short title here... (Eg: Home)" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="field">
                                                        ...
                                                        <textarea name="content-{{ $language->id }}" class="form-control my-editor">{{ old('content-'.$language->id,$blogDescription->content ?? '') }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="upload-bx">
                                                        <div class="field file_manager_field">
                                                            <input type="text" id="thumbnail{{ $language->id }}" name="image-{{ $language->id }}" value="{{ old('image-'.$language->id,(isset($blogDescription->image) ? asset($blogDescription->image) : '') )  }}" />
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="field mbpx-15">
                                                            <select name="status-{{ $language->id }}">
                                                                <option value="">Select Status</option>
                                                                <option value="Active" @if( old('status-'.$language->id,$blogDescription->status ?? '') == 'Active' ) selected="" @endif>Active</option>
                                                                <option value="Inactive" @if( old('status-'.$language->id,$blogDescription->status ?? '') == 'Inactive' ) selected="" @endif>Inactive</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="field mbpx-15">
                                                            <select name="is_feature-{{ $language->id }}">
                                                                ...
                                                                <option value="1" @if( old('is_feature-'.$language->id,$blog->is_feature) == '1' ) selected="" @endif>Yes</option>
                                                                <option value="0" @if( old('is_feature-'.$language->id,$blog->is_feature) == '0' ) selected="" @endif>No</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <select name="blogcategory-{{ $language->id }}">
                                                            @if( !empty($blogtocategories) )
                                                                ...
                                                                <option value="{{ $category->id }}" @if( $category->id ==  $blogcate->category_id) selected="selected" @endif>{{ $category->title  }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="field">
                                                                ...
                                                                <input type="text"  name="meta_title-{{ $language->id }}" value="{{ old('meta_title-'.$language->id,$blogDescription->meta_title ?? '') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="col-md-12">
                                                            <div class="field">
                                                                ...
                                                                <input type="text"  name="meta_keywords-{{ $language->id }}" value="{{ old('meta_keywords-'.$language->id,$blogDescription->meta_keywords ?? '') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="col-md-12">
                                                            <div class="field">
                                                                ...
                                                                <input type="text"  name="meta_description-{{ $language->id }}" value="{{ old('meta_description-'.$language->id,$blogDescription->meta_description ?? '') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
