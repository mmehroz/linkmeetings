				...
				<div class="panel">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xl-11">	
                            ...
                            <div class="col-sm-12">
									<h2>@lang('admin/faqcategory.editfaq')</h2>
                                    ...
                                    {!! Form::open(array('route' => array('admin_faqcategory_update_post',$id), 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}

                                        @foreach($languages as $language)
                                        <?php
                                            $faq_categories_description = $getcategoryfaq->getDescriptionById($id,$language->id);
                                            // $gettittile = isset($faq_categories_description->title)
                                            $gettittile;
                                            if ($faq_categories_description) {
                                                $gettittile = $faq_categories_description->title;
                                            }else{
                                                $gettittile = "";
                                            }
                                        ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="field">
                                                                    ...
                                                                    <input type="text" value="{{ old('title-'.$language->id,$gettittile) }}" name="title-{{ $language->id }}" placeholder="Faq Category title..." />
                                                                </div>
                                                            </div>
                                                        </div>
