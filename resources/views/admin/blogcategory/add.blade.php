				...
				<div class="panel">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xl-11">	
                            ...
                            <div class="col-sm-12">
									<h2>@lang('admin/blogcategory.createblog')</h2>
                                    ...
                                    {!! Form::open(array('route' => 'admin_blogcategory_add_post', 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}
                                                ...
                                                <div class="row">
                                                    <div class="col-xl-8">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="field">
                                                                    ...
                                                                    <input type="text" value="{{ old('title-'.$language->id) }}" name="title-{{ $language->id }}" placeholder="Blog Category title here..." />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="field mbpx-15">
                                                                <label>@lang('admin/blogcategory.parentID')</label>
                                                                    <select name="parent_id-{{ $language->id }}">
                                                                        <option value="0">No Parent</option>
                                                                        <?php $parent_cats = $getcategoryblog->getParentBlogs($language->id); ?>
                                                                        @if($parent_cats)
                                                                            @foreach($parent_cats as $parent_cat)
                                                                            <option value="{{ $parent_cat->blog_category_id }}" @if( old('parent_id-'.$language->id) == $parent_cat->blog_category_id ) selected="" @endif>{{ $parent_cat->title }}</option>
                                                                            @endforeach
                                                                        @endif
                                                                    </select>
                                                                </div>
