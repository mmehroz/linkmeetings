				...
				<div class="panel">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xl-11">
                            ...
                            <div class="col-sm-12">
									<h2>@lang('admin/menu.editmenu')</h2>
                                    ...
                                    {!! Form::open(array('route' => array('admin_menu_update_post',$id), 'method' => 'post', 'class' => 'form-horizontal', 'files'=> true)) !!}

                                        @foreach($languages as $language)
                                        <?php
                                            $menu_description = $getmenu->getDescriptionById($id,$language->id);
                                        ?>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="field">
                                                                    ...
                                                                    <input type="text" value="{{ old('title-'.$language->id,$menu_description->title) }}" name="title-{{ $language->id }}" placeholder="Menu title here... (Eg: Home)" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="field">
                                                                    ...
                                                                    <select name="type-{{ $language->id }}">
                                                                        ...
                                                                        <option value="Custom" @if( old('type-'.$language->id,$menu_description->type) == 'Custom' ) selected="" @endif>Custom</option>
                                                                        <option value="Page" @if( old('type-'.$language->id,$menu_description->type) == 'Page' ) selected="" @endif>Page</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="field">
                                                                    ...
                                                                    <input type="text" value="{{ old('url-'.$language->id,$menu_description->url) }}" name="url-{{ $language->id }}" placeholder="Page url here..." />
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <select name="page_id-{{ $language->id }}">
                                                                        ...
                                                                        @foreach( $pages as $page )
                                                                             <option value="{{ $page->id }}" @if( $page->id == $menu_description->page_id) selected="" @endif>{{ $page->short_title }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="field">
                                                                    ...
                                                                    <select name="section-{{ $language->id }}">
                                                                            ...
                                                                            <option value="1" @if( old('section-'.$language->id,$menu->section) == '1' ) selected="" @endif>Header</option>
                                                                            <option value="2" @if( old('section-'.$language->id,$menu->section) == '2' ) selected="" @endif>Footer</option>
                                                                            <option value="3" @if( old('section-'.$language->id,$menu->section) == '3' ) selected="" @endif>Help</option>
                                                                            <option value="4" @if( old('section-'.$language->id,$menu->section) == '4' ) selected="" @endif>Quick Links</option>
                                                                            <option value="5" @if( old('section-'.$language->id,$menu->section) == '5' ) selected="" @endif>Partner with us</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="field">
                                                                    ...
                                                                    <select name="status-{{ $language->id }}" class="">
                                                                        ...
                                                                        <option value="Active" @if( old('status-'.$language->id,$menu->status) == 'Active' ) selected="" @endif>Active</option>
                                                                        <option value="Inactive" @if( old('status-'.$language->id,$menu->status) == 'Inactive' ) selected="" @endif>Inactive</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
